    ...
    public class NZWalksDbContext: DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            var difficulties = new List<Difficulty>()
            {
                new Difficulty()
                {
                    Id = Guid.Parse("f700641a-dd85-4e65-a834-13587f4ac5b6"),
                    Name = "Easy"
                },
                new Difficulty()
                {
                    Id = Guid.Parse("3aea4cff-a720-4d3d-b082-ec5f5a594da2"),
                    Name = "Medium"
                },
                new Difficulty()
                {
                    Id = Guid.Parse("84bdf8e1-02f9-4394-b4da-545e4bb11afc"),
                    Name = "Hard"
                }
            };
